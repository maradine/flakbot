...
class PropertiesManager {
	...
	static String directoryName = "config";

	static Properties loadPropertiesFromDisk(String propertiesName) throws IOException {
	...
	static void savePropertiesToDisk(String propertiesName, Properties props) {
		String path = directoryName + "/" + propertiesName + ".properties";
		try {
